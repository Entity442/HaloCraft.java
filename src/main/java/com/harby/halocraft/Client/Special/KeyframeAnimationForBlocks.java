...
@OnlyIn(Dist.CLIENT)
public class KeyframeAnimationForBlocks {
    public static void animate(BlockEntityModel<?> pModel, AnimationDefinition pAnimationDefinition, long pAccumulatedTime, float pScale, Vector3f pAnimationVecCache) {
