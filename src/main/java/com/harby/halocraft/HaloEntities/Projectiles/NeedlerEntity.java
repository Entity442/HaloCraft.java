...
public class NeedlerEntity extends BaseProjectileEntity{
    public NeedlerEntity(Level level, Entity livingEntity, AmmoList ammo, EntityType<? extends NeedlerEntity> entityType, double speed) {
    ...
    public NeedlerEntity(Level level, EntityType<? extends NeedlerEntity> entityType) {
